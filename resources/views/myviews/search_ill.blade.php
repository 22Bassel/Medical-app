...
<body class="afef">
<form  action="/search_name" method="post" role="form">
                        ...
                        <div class="container-fluid nav-bar">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a class="menu"  onclick="ShowAndHide()" >our services </a></li>
    ...
    <div style="text-align: center;padding-top: 175px" >
        <legend  style="text-align: center;font-size:60px;color: red">search illness by name</legend>
        <h3>please enter the name of ill</h3>

        <input style="font-size: large" type="text"  name="name" id="name"  placeholder="Enter the name...">
        </input><br>
        <h3>please enter country</h3>

        <input style="font-size: large" type="text"  name="country" id="country"  placeholder="Enter the country...">
        </input><br>

        <div  style="text-align: center ;">
            <button   style="margin-top:20px;font-size: 20px;background-color: black;color: red" type="submit" class="btn btn-primary">Confirm</button>
        </div>
    </div>
</form>
<br>
